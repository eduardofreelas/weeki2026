...
import { BarChart3, CalendarDays, CheckCircle2, CirclePlus, FileCheck2, FileSignature, Inbox, Search, Settings, UserRound } from "lucide-react";
import {
  CommandDialog,
  CommandEmpty,
  CommandGroup,
    ...
    <CommandDialog open={open} onOpenChange={onOpenChange} title="Comandos rápidos do Weeki" description="Crie ou encontre uma demanda" className="top-[36%] max-w-xl rounded-2xl border-slate-200 shadow-2xl">
      ...
      <CommandList className="max-h-[360px] p-2">
        ...
        <CommandGroup heading="Ações rápidas">
          ...
          <CommandItem onSelect={() => run(() => onNavigate("reports"))}><BarChart3 /> Abrir Relatórios</CommandItem>
